...
{
    ComInitCube* maCom;
    maCom = new ComInitCube("/dev/ttyAMA0",9600);
    string message = "";
    maCom->lireTrame(message); //On stocke le message pour l'envoyer dans "message"
    cout << "Trame reçue : " << message << endl;
    maCom->transmettreTrame("ACK\r\n");
}
